...
type BookingService interface {
	FindAll(model models.Booking, search string, currentPage int, pageSize int, instructorID string, customerID string) ([]models.Booking, int64, int, error)
...
func (s bookingService) FindAll(model models.Booking, search string, currentPage int, pageSize int, instructorID string, customerID string) ([]models.Booking, int64, int, error) {
	bookings, total, currentPage, err := s.repository.FindAll(model, search, currentPage, pageSize, instructorID, customerID)
	if err != nil {
